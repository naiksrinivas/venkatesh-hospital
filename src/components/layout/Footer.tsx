    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/services/laboratory" className="hover:text-white transition-colors">
                  Laboratory Services
                </Link>
              </li>
              <li>
                <Link href="/services/radiology" className="hover:text-white transition-colors">
                  Radiology Services
                </Link>
              </li>
              <li>
                <Link href="/services/pharmacy" className="hover:text-white transition-colors">
                  Pharmacy
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-sm text-center">
          <p>© {new Date().getFullYear()} Medical Hospital. All rights reserved.</p>
